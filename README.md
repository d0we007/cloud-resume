...
This is my Cloud Resume Challenge built on AWS. It's a website hosted on AWS S3 Storage, with a visitor counter built on AWS Functions. The website is built with HTML, CSS, and JavaScript. The visitor counter is built with .NET and AWS Functions. 
